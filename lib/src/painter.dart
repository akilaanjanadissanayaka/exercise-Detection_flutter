...
class PosePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    sideLuge(canvas, size);
  }

  void squat(Canvas canvas, Size size) {
    PoseLandmark? leftShoulder = pose.landmark(PoseLandmarkType.LEFT_SHOULDER);
    PoseLandmark? rightShoulder =
        pose.landmark(PoseLandmarkType.RIGHT_SHOULDER);
    ...
    if (leftHip != null && leftKnee != null) {
      print("################################################################");
      print("leftHip: " + transformY(leftHip.position.dy, size).toString());
      print("leftKnee: " + transformY(leftKnee.position.dy, size).toString());

      if ((transformY(leftKnee.position.dy, size) -
              transformY(leftHip.position.dy, size)) <
          20) {
        position = "down";
        print(position);
      }
  ...
  void innerTie(Canvas canvas, Size size) {
    ...
    if (nose != null && leftWrist != null && rightWrist != null) {
      print("################################################################");
      print("nose: " + transformX(nose.position.dy, size).toString());
      print("leftWrist: " + transformX(leftWrist.position.dy, size).toString());
      print(
          "rightWrist: " + transformX(rightWrist.position.dy, size).toString());

      if ((transformX(nose.position.dx, size) >
  ...
  void sideLuge(Canvas canvas, Size size) {
    PoseLandmark? leftHeel = pose.landmark(PoseLandmarkType.LEFT_HEEL);
    PoseLandmark? rightHeel = pose.landmark(PoseLandmarkType.RIGHT_HEEL);
    ...
    if (leftKnee != null && rightKnee != null && leftHeel != null && rightHeel != null) {
      print("################################################################");
      ...
      print("leftHeel: " + transformX(leftHeel.position.dx, size).toString());
      print( "rightHeel: " + transformX(rightHeel.position.dx, size).toString());

      if((transformX(leftHeel.position.dx, size)<transformX(leftKnee.position.dx, size)) ){
        position="left";
        print(position);
      }

      if(transformX(rightHeel.position.dx, size)>transformX(rightKnee.position.dx, size) ){
        position="right";
        print(position);
      }
